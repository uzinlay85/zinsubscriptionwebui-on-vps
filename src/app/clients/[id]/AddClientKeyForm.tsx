      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in">
          <div className="glass-card w-full max-w-md p-6 relative">
            ...
            <h2 className="text-xl font-bold text-white mb-6">Assign Server Access</h2>
            ...
            <form action={handleSubmit} className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-zinc-400 mb-1">Outline Key ID</label>
                <input 
                  type="text" 
                  name="outlineKeyId" 
                  required
              ...
              <div>
                <label className="block text-sm font-medium text-zinc-400 mb-1">Access URL (ss://...)</label>
                <input 
                  type="text" 
                  name="accessUrl" 
                  required
                  className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-2.5 text-white focus:outline-none focus:border-emerald-500 transition-colors font-mono text-xs"
                  placeholder="ss://..."
                />
              </div>
